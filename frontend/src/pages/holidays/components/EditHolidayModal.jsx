            ...
            {isOpen && (
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-100 dark:border-github-dark-border bg-slate-50/50 dark:bg-github-dark-subtle/20">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-sm font-semibold text-slate-800 dark:text-github-dark-text">Edit Holiday</h3>
                    </div>
                    <button
                        onClick={onClose}
                ...
                {/* Body */}
                <form onSubmit={onUpdateHoliday} className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
