        ...
        <div className="flex flex-col xl:flex-row justify-between xl:items-center gap-3 select-none">
            <div className="flex items-center gap-2.5 flex-wrap">
                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs transition-all duration-200 cursor-pointer ${isSelected
                                    ? 'bg-white dark:bg-[#21262d] text-[#0969da] dark:text-[#58a6ff] font-medium shadow-sm border border-transparent dark:border-[#30363d]'
                                    : 'text-slate-600 dark:text-[#8b949e] hover:text-slate-900 dark:hover:text-[#f0f6fc] hover:bg-slate-200/50 dark:hover:bg-[#21262d]/50 font-normal'
                                    }`}
                            >
                                {tab.icon}
                                <span>{tab.label}</span>
                ...
                {activeTab === 'sites' && selectedSite !== null && (
                    <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-[#8b949e] select-none bg-[#f6f8fa] dark:bg-[#161b22] px-3 py-1.5 rounded-xl border border-[#d0d7de] dark:border-[#30363d]">
                        <span className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer transition-colors font-normal" onClick={() => setSelectedSite(null)}>Sites Overview</span>
                        <ChevronRight size={12} className="text-slate-400 dark:text-slate-500" />
                        <span className="text-slate-800 dark:text-[#f0f6fc] font-semibold">{selectedSite.site_name}</span>
                        <span className={`ml-1 px-1.5 py-0.5 text-[9px] font-medium rounded-full uppercase ${
                            selectedSite.status === 'Active'
                                ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border dark:border-emerald-800/40'
                                : 'bg-slate-100 text-slate-500 dark:bg-[#21262d] dark:text-slate-400'
                        }`}>
                            {selectedSite.status}
                        </span>
                    </div>
                ...
                <div className="flex items-center gap-2 flex-wrap ml-auto">
                    ...
                    <div className="relative w-44 sm:w-52">
                        ...
                        <input
                            ...
                            className="pl-8 pr-2.5 py-1.5 w-full bg-white dark:bg-[#161b22] border border-slate-200 dark:border-[#30363d] rounded-lg text-xs text-slate-700 dark:text-[#f0f6fc] placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-500 shadow-2xs h-[32px]"
                        />
                    </div>
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg text-xs font-medium shadow-2xs transition-all border border-[#d0d7de] dark:border-[#30363d] cursor-pointer h-[32px] shrink-0"
                    >
                        <Building size={13} />
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-medium shadow-2xs transition-all cursor-pointer h-[32px] shrink-0"
                    >
                        <Upload size={13} />
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-medium shadow-2xs transition-all cursor-pointer h-[32px] shrink-0"
                    >
                        <UserPlus size={13} />
                        ...
                        {[
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs transition-all duration-200 cursor-pointer ${isSelected
                                        ? 'bg-white dark:bg-[#21262d] text-[#0969da] dark:text-[#58a6ff] dark:border dark:border-[#30363d] font-medium shadow-sm'
                                        : 'text-slate-600 dark:text-[#8b949e] hover:text-slate-900 dark:hover:text-[#f0f6fc] dark:hover:bg-[#21262d]/40 font-normal'
                                    }`}
                                >
                                    {tab.icon}
                                    <span>{tab.label}</span>
