                    ...
                    >
                        <div className="flex justify-between items-center p-5 border-b border-slate-100 dark:border-[#30363d] bg-slate-50/30 dark:bg-[#010409]/40">
                            <div>
                                ...
                                <p className="text-[9px] font-medium text-slate-400 dark:text-github-dark-muted mt-0.5 tracking-wider uppercase">Worker Configuration Profile</p>
                            </div>
                        ...
                        <form onSubmit={handleSaveLabour} className="flex-1 overflow-y-auto p-6 space-y-4 text-xs custom-scrollbar">
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Labour Full Name</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Contact Phone</label>
                                <input
                                    type="tel"
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Sex</label>
                                <MinimalSelect
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Role</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Assign Construction Site</label>
                                <MinimalSelect
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Overtime Pay (per hour)</label>
                                <input
                                    type="number"
                            ...
                            {editingLabour && (
                                <div>
                                    <label className="block text-slate-500 dark:text-slate-300 font-medium mb-1">Status</label>
                                    <MinimalSelect
                            ...
                            <div className="flex gap-3 pt-6 border-t border-slate-100 dark:border-[#30363d]">
                                <button
                                    type="button"
                                    onClick={() => setShowLabourModal(false)}
                                    className="flex-1 px-4 py-2.5 bg-slate-100 hover:bg-slate-205 dark:bg-slate-800 text-slate-500 rounded-lg font-medium transition-all"
                                >
                                    Cancel
                                </button>
                                <button
