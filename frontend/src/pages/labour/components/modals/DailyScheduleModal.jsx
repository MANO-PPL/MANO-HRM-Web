        ...
        <AnimatePresence>
            {showScheduleModal && selectedScheduleLabour && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center overflow-hidden p-4">
                    ...
                    >
                        <div className="flex justify-between items-center p-5 border-b border-slate-100 dark:border-[#30363d] bg-slate-50/50 dark:bg-[#161b22]/50">
                            <div>
                                <h4 className="font-semibold text-sm text-slate-800 dark:text-[#f0f6fc] uppercase tracking-wider">
                                    Daily Site Schedule
                                </h4>
                                <p className="text-[9px] font-medium text-indigo-550 dark:text-indigo-400 mt-0.5 tracking-wider uppercase">
                        ...
                        <div className="p-6 space-y-4 text-xs flex-1">
                            <div>
                                <label className="block text-slate-500 dark:text-[#8b949e] font-medium mb-1.5 uppercase tracking-wide text-[10px]">Select Target Date</label>
                                <DatePicker
                                    value={scheduleDate}
                            ...
                            <div>
                                <label className="block text-slate-500 dark:text-[#8b949e] font-medium mb-2 uppercase tracking-wide text-[10px]">
                                ...
                                {scheduleLoading ? (
                                    ...
                                    <div className="max-h-[220px] overflow-y-auto pr-1 space-y-2 border border-slate-100 dark:border-[#30363d] rounded-xl p-3 bg-slate-50/30 dark:bg-[#161b22]/40 custom-scrollbar">
                                        {sites.map(site => {
                                                ...
                                                <div
                                                    ...
                                                    className={`flex items-center justify-between p-2.5 rounded-lg border transition-all cursor-pointer select-none ${
                                                        isChecked
                                                            ...
                                                            : 'border-slate-100 dark:border-[#30363d] text-slate-650 dark:text-[#c9d1d9] hover:bg-slate-50 dark:hover:bg-[#21262d]'
                                                    }`}
                                                >
                                                    ...
                                                    {isPrimary && (
                                                        <span className="px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-500 font-medium text-[8px] uppercase tracking-wider">
                                                            Primary
                                                        </span>
                                                    )}
                                                </div>
                            ...
                            <p className="text-[10px] text-slate-400 dark:text-[#8b949e] italic leading-relaxed">
                                Note: If no daily schedule is configured for a date, the worker will automatically default to their primary site checklist.
                            </p>
                        </div>

                        <div className="p-4 border-t border-slate-100 dark:border-[#30363d] bg-slate-50/50 dark:bg-[#161b22]/40 flex justify-end gap-2">
                            <button
                                type="button"
                                onClick={() => setShowScheduleModal(false)}
                                className="px-4 py-2 border border-slate-200 dark:border-[#30363d] rounded-lg font-medium text-slate-600 dark:text-github-dark-muted hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="px-4 py-2 bg-indigo-650 hover:bg-indigo-700 text-white rounded-lg font-medium shadow-md hover:shadow-indigo-550/20 transition-all cursor-pointer disabled:opacity-50"
                            >
                                Save Schedule
                            </button>
                        </div>
