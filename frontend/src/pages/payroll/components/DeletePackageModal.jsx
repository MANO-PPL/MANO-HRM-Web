            ...
            <div className="flex min-h-full items-center justify-center p-4">
                <div className="relative w-full max-w-lg bg-white dark:bg-github-dark-subtle border border-slate-200 dark:border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 mx-auto">
                    <div className="p-10 text-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 dark:text-github-dark-text mb-3">Delete Salary Package?</h3>
                        ...
                        <div className="flex gap-4">
                            <button
                                onClick={onClose}
                                className="flex-1 px-6 py-3 rounded-xl bg-slate-100 dark:bg-github-dark-subtle/55 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-github-dark-text font-medium text-xs transition-all cursor-pointer"
                            >
                                Keep it
                            </button>
                            <button
